...
def overwrite_ep_weather(state):
    ...
    if not overwrite_ep_weather_inited_handle:
        ...
        if "HighOffice" in coordination.bld_type or 'SimplifiedHighBld' in coordination.bld_type:
    ...
    if not warm_up:
        ...
        if "SmallOffice" in coordination.bld_type:
            ...
            coordination.ep_api.exchange.set_actuator_value(state, Surface_576_roof_hConv_actuator_handle,
                                                            coordination.vcwg_hConv_w_m2_per_K)
            coordination.ep_api.exchange.set_actuator_value(state, Surface_582_roof_hConv_actuator_handle,
                                                            coordination.vcwg_hConv_w_m2_per_K)
            coordination.ep_api.exchange.set_actuator_value(state, Surface_588_roof_hConv_actuator_handle,
                                                            coordination.vcwg_hConv_w_m2_per_K)
            coordination.ep_api.exchange.set_actuator_value(state, Surface_594_roof_hConv_actuator_handle,
                                                            coordination.vcwg_hConv_w_m2_per_K)
            coordination.ep_api.exchange.set_actuator_value(state, Surface_600_roof_hConv_actuator_handle,
                                                            coordination.vcwg_hConv_w_m2_per_K)
...
def batch_get_medoffice_wall_temperatures(state, dic):
...
def MediumOffice_get_ep_results(state):
    ...
    if called_vcwg_bool:
        ...
        est_c, wst_c = batch_get_medoffice_wall_temperatures(state, e_w_handles)
