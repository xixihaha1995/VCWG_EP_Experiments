...
def _batch_HighOffice_wall_handles(state):
    wall_handles_dict = {}
...
def _batch_check_wall_handles(wall_handles_dict):
...
def _batch_get_20_stories_temperatures(state, wall_handles_dict, roof_floors_handles_dict):
...
def _batch_highoffice_roof_floor_handels(state):
    roof_flr_dict = {}
    roof_flr_dict['roof'] = []
    roof_flr_dict['floor'] = []
